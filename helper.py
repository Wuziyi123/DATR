...
class GOAL_CLIP(nn.Module):
    ...
    def encode_image(self, images):
        ...
        all_feats = torch.cat([global_feat, crop_feats], dim=1).mean(dim=1)
    ...
    def encode_text(self, texts):
        ...
        return torch.stack(text_feats, dim=1).reshape(-1, text_feats[0].shape[-1])
    ...
    def forward(self, images, texts):
        ...
        # text_features = self.text_augmentation(text_features)
        # 投影到共享空间
